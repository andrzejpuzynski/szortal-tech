	...
	render() {
		return (
			<WorkflowContainer>
				...
				<WorkflowStep area="aa" editor onClick={() => this.props.toggleInfoBox("workflowMockupSource")}
					> makieta źródłowa
				...
				<WorkflowStep area="fe" dtp application="Indesign" onClick={() => this.props.toggleInfoBox("workflowPdfFormatting")}
					> skład PDF
					<WorkflowStepArrow top dtp/>
				</WorkflowStep>
				...
				<WorkflowStep area="gd" dtp application="Calibre" onClick={() => this.props.toggleInfoBox("workflowHtmlToXml")}
